...
def main():
    ...
    parser.add_argument("--data_dir", default="./dataset/vda", type=str)
    parser.add_argument("--transformer_type", default="bert", type=str)
    # parser.add_argument("--model_name_or_path", default="dmis/biobert-v1.1", type=str)
    # parser.add_argument("--model_name_or_path", default="allenai/scibert_scivocab_cased", type=str)
    parser.add_argument("--model_name_or_path", default="microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract", type=str)

    parser.add_argument("--train_file", default="vdal_train.data", type=str)
    parser.add_argument("--dev_file", default="vdal_dev.data", type=str)
    parser.add_argument("--test_file", default="vdal_test.data", type=str)
    parser.add_argument("--load_path", default="", type=str)
    # parser.add_argument("--save_path", default="saved_models/VDANet.pt", type=str)
