...
class DocREModel(nn.Module):
    ...
    def encode(self, input_ids, attention_mask, cg_ids):
        config = self.config
        ...
        sequence_output, attention = process_long_input(self.model, input_ids, attention_mask, start_tokens, end_tokens, cg_ids=None)
    ...
    def forward(self,
        ...
        sequence_output, attention = self.encode(input_ids, attention_mask, cg_ids)
